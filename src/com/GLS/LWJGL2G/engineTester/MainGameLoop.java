...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		objects.add(new Entity(new TexturedModel(OBJLoader.loadObjModel("dragon", loader),new ModelTexture(loader.loadTexture("dragonTexture")).setShineDamper(10).setReflectivity(1)),new Vector3f(0,0,-25f),0,0,0,1f));
